...
var br = (r, o, i) => (Dr(r, o, "read from private field"), i ? i.call(r) : o.get(r));
var Co = (r, o, i) => {
  if (o.has(r))
    throw TypeError("Cannot add the same private member more than once");
  o instanceof WeakSet ? o.add(r) : o.set(r, i);
};
var $o = (r, o, i, c) => (Dr(r, o, "write to private field"), o.set(r, i), i);
var Ar = [
  ["aztec", "Aztec"],
  ["code_128", "Code128"],
  ["code_39", "Code39"],
...
var dt = (() => {
  ...
  return function(o = {}) {
    ...
    var ze = [], Ge = 0, sn = (e) => {
      var t = new wt(e);
      return t.get_caught() || (t.set_caught(true), Ge--), t.set_rethrown(false), ze.push(t), hr(t.excPtr), t.get_exception_ptr();
    }, se = 0, cn = () => {
      L(0, 0);
      var e = ze.pop();
      fr(e.excPtr), se = 0;
    ...
    var un = (e) => {
      ...
      var t = e.excPtr;
      throw e.get_rethrown() || (ze.push(e), e.set_rethrown(true), e.set_caught(false), Ge++), se = t, se;
    }, pn = (e, t, n) => {
      var a = new wt(e);
...
` + s.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      Tt(O, function() {
        ...
        var Se = new Ke(_, P, true, false, false), at = new Ke(_ + "*", P, false, false, false), gr = new Ke(_ + " const*", P, false, true, false);
        return Jt[e] = {
          pointerType: at,
          constPointerType: gr
        }, Zt(O, J), [Se, at, gr];
...
`,
    ...
    function yr() {
      if (te > 0 || (He(), te > 0))
        return;
      function e() {
        nt || (nt = true, i.calledRun = true, !W && (ft(), c(i), i.onRuntimeInitialized && i.onRuntimeInitialized(), ht()));
      }
...
var zr = async (r, o = ["qr_code"]) => await new je({ formats: o }).detect(r);
var oi = async (r, o = ["qr_code"]) => {
      ...
      async (k) => {
        ...
        if (ae(le !== null, "if cavnas is defined, canvas 2d context should also be non-null"), k.shouldStream) {
          ...
          try {
            ...
            C.value ? (p.value = true, c("camera-on", ie)) : await st();
          } catch (ie) {
            c("error", ie);
          }
        } else
          D.width = M.videoWidth, D.height = M.videoHeight, le.drawImage(M, 0, 0, M.videoWidth, M.videoHeight), st(), p.value = false, c("camera-off");
      },
      { deep: true }
    ), watch(h, async (k) => {
      C.value && await Nr(k);
...
var Wi = defineComponent({
  ...
  setup(r, { emit: o }) {
    ...
    return (h, v) => (openBlock(), createElementBlock("input", {
      onChange: l,
      type: "file",
      name: "image",
      accept: "image/*",
...
var Li = defineComponent({
  ...
  setup(r, { emit: o }) {
    ...
    return (g, b) => (openBlock(), createElementBlock("div", {
      onDrop: withModifiers(v, ["prevent", "stop"]),
      onDragenter: b[0] || (b[0] = withModifiers((p) => h(true), ["prevent", "stop"])),
      onDragleave: b[1] || (b[1] = withModifiers((p) => h(false), ["prevent", "stop"])),
      onDragover: b[2] || (b[2] = withModifiers(() => {
      }, ["prevent", "stop"]))
    }, [
